        ...
        if(this.state.password === this.state.confirmPassword) {
            ...
            .then(res => {
                if(res.status === 401){
                    ...
                    this.props.onAuthChange({ isLoggedIn: 'true', isAdmin: 'false'});
            ...
            <div className='sign-up-container'>
                ...
                <div className='form-container'>
                    <form>
                        ...
                        <input className='input' name='username' type='email' label='Email' placeholder='Email ID' value={this.state.email} onChange={this.handleChange} required />
                        ...
                        <button className='button' type='submit' onClick={this.handleSubmit}>Register</button>
                    </form>
                </div>
            </div>
        );
