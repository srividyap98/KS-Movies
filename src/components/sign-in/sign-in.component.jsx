...
class SignIn extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        .then(res => {
            ...
            this.props.onAuthChange({ isLoggedIn: 'true', isAdmin: res.admin });
        ...
        return(
            <div className='sign-in-container'>
                ...
                <div className='form-container'>
                    <form>
                        <input className='input' name='username' type='email' label='email' placeholder='Email Id' value={this.state.username} onChange={this.handleChange} required />
